...
// /* 7 command-line parsing */
    if(argc==1)
        printf("No pasaste ningun parametro de lo que queres testear!\n");
    ...
    if(argc>=2)
    {
        ...
        {
        case 'a':
            printf("Corriendo test agregar...");
            testeando_agregar();
            printf("Paso!\n");
            break;

        case 'e':
            printf("Corriendo test eliminar... ");
            testeando_eliminar();
            printf("Paso!\n");
            break;

        case 'm':
            printf("Corriendo test minimo... ");
            testeando_minimo_elem_matriz();
            printf("Paso!\n");
            break;

        case 's':
            printf("Corriendo test sumaprod... ");
            testeando_sumaprod_matriz();
            printf("Paso!\n");
            break;

        case 'f':
            printf("Corriendo test sumafilcol... ");
